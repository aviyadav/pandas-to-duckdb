...
if __name__ == "__main__":
    ...
    imput_csv = os.path.join(base_dir, "data/1449", "MrBeast_youtube_stats.csv")
    output_parquet = os.path.join(
        base_dir, "data", "MrBeast_youtube_stats_processed.parquet"
    )

    process_data(imput_csv, output_parquet)
